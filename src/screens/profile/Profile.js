        ...
        <div className="information-section">
          ...
          <span style={{ marginLeft: "20px" }}>
            <div style={{ width: "600px", fontSize: "big" }}> {this.state.username} <br />
              <div style={{ float: "left", width: "100px", fontSize: "x-small" }}> Posts: {this.state.posts} </div>
              <div style={{ float: "left", width: "100px", fontSize: "x-small" }}> Follows: {this.state.follows} </div>
              <div style={{ float: "left", width: "100px", fontSize: "x-small" }}> Followed By: {this.state.followed_by}</div> <br />
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', backgroundColor: "#fff", width: '70%', height: '70%' }}>
              <div style={{ width: '50%', padding: 10 }}>
                <img style={{ height: '100%', width: '100%' }}
                  ...
                  alt={this.state.currentItem.caption != null ? this.state.currentItem.caption.text : ""} />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', width: '50%', padding: 10 }}>
                ...
                <div style={{ display: 'flex', height: '100%', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div>
                    <Typography component="p">
                      {this.state.currentItem.caption != null ? this.state.currentItem.caption.text : ""}
                    </Typography>
